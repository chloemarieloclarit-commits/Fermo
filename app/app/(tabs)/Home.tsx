...
const IrrigationDashboard = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-blue-100">
      ...
      <View className="flex flex-row  items-center gap-5 px-5 py-5 bg-blue-300 shadow-sm border-b border-blue-400 pt-10">
        <Image source={logo} style={{ width: 50, height: 50 }} />
        <Text className="text-3xl font-extrabold text-orange-500">Home</Text>
      </View>
      <View className="flex flex-col h-aut py-5 mx-5 my-5 bg-white shadow-sm border-b border-gray-100 rounded-lg items-center" onLayout={(event)=>{ setWidth(event.nativeEvent.layout.width);}}>
        <View className="w-full h-fit  mb-7 px-5"><Text className="text-black text-2xl font-bold">Data summary/Updates/Anything you want to put in here...</Text></View>
