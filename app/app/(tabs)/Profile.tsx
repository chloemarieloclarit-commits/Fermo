    ...
    return(
        <SafeAreaView className="flex-1 bg-blue-100">
            ...
            >
                ...
                <View className="flex flex-row  items-center gap-5 px-5 py-4 bg-blue-300 shadow-sm border-b border-blue-400 pt-1">
                    <Image source={logo} style={{ width: 50, height: 50 }} />
                    <Text className="text-3xl font-extrabold text-orange-500">Profile</Text>
                </View>

                <View className="px-7 py-10 mx-5 my-5 bg-blue-300 shadow-sm border-b border-gray-100 rounded-lg">
                    ...
                    <View className="flex-1 mx-auto w-full h-auto gap-4 mt-10 items-end">
                        <TouchableOpacity
                            ...
                            className="flex flex-row gap-2 bg-red-600 py-4 px-8 rounded-lg mx-6 w-fit"
                        >
