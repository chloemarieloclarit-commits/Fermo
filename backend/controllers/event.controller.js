...
export const submitData = async (req, res) => {
  ...
  let temperature = Number(req.body.temperature) || 0;
  let pH1 = Number(req.body.pH1) || 0;
  let pH2 = Number(req.body.pH2) || 0;
  let pH3 = Number(req.body.pH3) || 0;
  ...
  try {
    ...
    const newEvent = new Event({
      ...
      pH2,
      pH3,
      // eventDate & eventType use schema defaults
    });

    await newEvent.save({ session });

    // Optional: update device status
